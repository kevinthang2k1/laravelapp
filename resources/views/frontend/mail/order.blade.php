...
<body>
    <div class="cart-success">
        {{-- <div class="panel-head">
            ...
            <div class="discover-text"><a href="{{ write_url('san_pham') }}">Khám phá thêm các sản phẩm tại đây</a></div>
        </div> --}}
        <div class="panel-body">
            <h2 class="cart-heading"><span>Thông tin sản phẩm</span></h2>
                    ...
                    <table class="table">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                ...
                                <td><strong>{{ convert_price($data['cartCaculate']['cartDiscount'] + $data['cartCaculate']['cartTotal'], true) }}VND</strong></td>
                            </tr>
                            <tr>
                                <td colspan="4">Tổng giá trị khuyến mại</td>
                                <td><strong>{{ convert_price($data['cartCaculate']['cartDiscount'], true) }}VND</strong></td>
                            </tr>
                            <tr>
                            ...
                            <tr class="total_payment">
                                ...
                                <td>{{ convert_price($data['cartCaculate']['cartTotal'], true) }}VND</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
