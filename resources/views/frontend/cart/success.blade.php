                    ...
                    <table class="table">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                ...
                                <td><strong>{{ convert_price($order->promotion['discount'] + $order->cart['cartTotal'], true) }}VND</strong></td>
                            </tr>
                            <tr>
                                <td colspan="4">Tổng giá trị khuyến mại</td>
                                <td><strong>{{ convert_price($order->promotion['discount'], true) }}VND</strong></td>
                            </tr>
                            <tr>
                            ...
                            <tr class="total_payment">
                                ...
                                <td>{{ convert_price($order->cart['cartTotal'], true) }}VND</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
