...
@section('content')
    <div class="product-catalogue page-wrapper">
        <div class="uk-container uk-container-center">
            @include('frontend.component.breadcrumb', ['model' => $productCatalogue, 'breadcrumb' => $breadcrumb]) {{-- phần breadcrumb này liên quan đến cấu trúc danh mục cha con --}}
                    ...
                    <div class="uk-flex uk-flex-middle uk-flex-space-between">
                        ...
                        <div class="sorting">
                            <select name="sort" class="nice-select filtering" style="display: none;">
                                ...
                                <option value="price:asc">Giá: Từ thấy đến cao</option>
                    ...
                    <div class="product-list">
                        <div class="uk-grid uk-grid-medium">
                            @foreach ($products as $product)
                                <div class="uk-width-1-2 uk-width-small-1-2 uk-width-medium-1-3 uk-with-large-1-5 mb20">
