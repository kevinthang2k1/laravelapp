<div class="ibox">
    ...
    <div class="ibox-content">
        <div id="sortable" class="row slide-list sortui ui-sortable">
            <div class="text-danger slide-notification {{ (count($slides) > 0) ? 'hidden' : '' }}">Chưa có hình ảnh được chọn....</div>
            @if(!is_null($slides) && is_array($slides) && count($slides))
