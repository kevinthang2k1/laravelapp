    ...
    <div class="ibox">
        ...
        <div class="ibox-content">
            ...
            <div class="apply-wrapper">
                <select name="applyValue[]" class="multipleSelect2 conditionItem" multiple id="">
                ...
                <div class="wrapper-condition">
                    <div class="wrapperConditionItem mt10 customer_gender">
                        <div class="mb5"><div class="uk-flex uk-flex-middle uk-flex-space-between"><div class="conditionLabel">Giới tình</div></div></div>
                        <select name="applyValue[]" class="multipleSelect2" multiple id="">
                            @foreach(__('module.applyStatus') as $key => $val)
                                <option 
