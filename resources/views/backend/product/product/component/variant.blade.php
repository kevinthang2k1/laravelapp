{{-- @dd(json_decode($product->attributeCatalogue)); --}}
<div class="ibox variant-box">
    ...
    <div class="ibox-content">
        ...
        @php
            $variantCatalogue = old('attributeCatalogue', (isset
                ...
                <div class="row mb20 variant-item">
                    <div class="col-lg-3">
                        <div class="attribute-catalogue">
                            <select name="attrbuteCatalogue[]" id="" class="choose-attribute niceSelect">
                                ...
                                @endforeach
                                <option value="'+attributeCatalogue[i].id+'">'+attributeCatalogue[i].name+'</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-8">
                        {{-- <input type="text" name="" disabled class="fake-variant form-control"> --}}
                        <select name="attribute[{{ $valAttr }}][]" class="selectVariant variant-{{ $valAttr }} from-control" name="attribute['+attributeCatalogueId+'][]" multiple data-catid="{{ $valAttr }}" id=""></select>
                    </div>
                    <div class="col-lg-1">
