                            ...
                            <div id="collapseOne" class="panel-collapse collapse ">
                                <div class="panel-body">
                                    ...
                                    <div class="panel-description">
                                        ...
                                        <a style="color:#000;broder-color=#c4cdd5;display:inline-block !important;" href="" title="" class="btn btn-default add-menu m-b m-r right">Thêm đường dẫn</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row menu-item">
                            ...
                            <div class="col-lg-2">
                                <div class="form-row-center">
                                    <a class="delete-menu">
                                        <img src="backend/img/icons8-close-52.png">
                                    </a>
                                </div>
                                <input
                                    type="text"
