...
class PermissionController extends Controller
{
    ...
    public function update($id, UpdatePermissionRequest $request){
        ...
        return redirect()->route('permission.admin')->with('error', 'Cập nhật bản ghi không thành công. Hãy thử lại');
    }
    ...
    public function destroy($id){
        ...
        return redirect()->route('permission.admin')->with('error', 'Xóa bản ghi không thành công. Hãy thử lại');
    }
