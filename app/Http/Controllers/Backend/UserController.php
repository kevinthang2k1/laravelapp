...
class UserController extends Controller
{
    ...
    public function store(StoreUserRequest $request){
        ...
        return redirect()->route('user.admin')->with('error', 'Thêm mới bản ghi không thành công. Hãy thử lại');
    }
    ...
    public function update($id, UpdateUserRequest $request){
        ...
        return redirect()->route('user.admin')->with('error', 'Cập nhật bản ghi không thành công. Hãy thử lại');
    }
    ...
    public function destroy($id){
        ...
        return redirect()->route('user.admin')->with('error', 'Xóa bản ghi không thành công. Hãy thử lại');
    }
