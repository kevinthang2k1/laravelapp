...
class CustomerCatalogueController extends Controller
{
    ...
    public function store(StoreCustomerCatalogueRequest $request){
        ...
        return redirect()->route('customer.catalogue.admin')->with('error', 'Thêm mới bản ghi không thành công. Hãy thử lại');
    }
    ...
    public function update($id, StoreCustomerCatalogueRequest $request){
        ...
        return redirect()->route('customer.catalogue.admin')->with('error', 'Cập nhật bản ghi không thành công. Hãy thử lại');
    }
    ...
    public function destroy($id){
        ...
        return redirect()->route('customer.catalogue.admin')->with('error', 'Xóa bản ghi không thành công. Hãy thử lại');
    }
}
